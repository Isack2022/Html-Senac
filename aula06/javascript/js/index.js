 ...
 */
    ...
    */
    ...
    function back(){
        diplay.value= diplay.value.substring(0,diplay.value.length-1);
    }
    ...
    function adicionaPonto(){
        /*
        Para o botão ponto estamos verificandi se o ponto já foi adicionado.
    ...
    function igual(){
        if(operador=="+"){
            ...
            resultado = (parseFloat(diplay.value)*valor1/100);          
            diplay.value = resultado;
        }
        else{
            console.log("Error");
